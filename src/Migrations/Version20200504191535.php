 ...
 */
final class Version20200504191535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__issue_votes AS SELECT id, user_id, amount, issue_id FROM issue_votes');
        ...
        $this->addSql('INSERT INTO issue_votes (id, user_id, amount, issue_id) SELECT id, user_id, amount, issue_id FROM __temp__issue_votes');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE issue_votes');
        $this->addSql('CREATE TABLE issue_votes (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id CHAR(36) NOT NULL --(DC2Type:uuid)
        , amount INTEGER NOT NULL, issue_id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:uuid)
        )');
